...
export function verification(url: string, link: string) {
                                ...
                                <tr>
                                    <td style="padding-bottom: 1px;">
                                        ...
                                        <p style="margin-bottom: 20px; margin-top: 0;">
                                            You're one step away from creating a Charity Token account!
                                        </p>
                                        <p style="margin-bottom: 20px; margin-top: 0;">
                                            Tap the button below to confirm your email address. If you didn't create an account with <a style="color: #74AF27; text-decoration: none;"
                                                href="https://charitytoken.online">Charity Token</a>, you can safely delete this email.
                                        </p>
                                        <p style="margin-bottom: 20px; margin-top: 0;">
                                            <a href="${link}" style="
                                            color: #FFFFFF;
